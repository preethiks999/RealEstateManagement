  ...
  return (
    <div className="flex justify-between">
     ...
     ></input> */}
        ...
        <input
          type="text"
          className="focus:outline shadow-lg mx-2 h-12 w-96 rounded-lg cursor-pointer px-2 hover:outline outline-indigo-500 bg-gray-100"
          value={searchSociety}
        ...
        <select
          name="flats"
          id="flats"
          className="shadow-lg mx-2 h-12 pl-1 w-48 rounded-lg cursor-pointer  hover:outline outline-indigo-500 bg-gray-100"
          value={selectedFlat}
